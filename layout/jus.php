...
<head>
    ...
    <!------icon du titre----->
    <link rel="shortcut icon"  href="images/images/Logo supermarché.png">
...
<body>
    ...
    <section id="produits" >
        <div class="produits-headings">
                <h1 class="produits-heading"><strong>BOISSONS-VINS</strong></h1>
                <!-- bouton de recherche---->
                 <form >
 ...
 <aside id="modal1" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/l-ananas-presse-du-togo-100-pur-jus-fabrique-a-partir-d-ananas-frais1.jpg">
                    <div class="designation">
                        <span class="nom2">ananas-presse</span><br>
                       <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu1">9000</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibilite">Disponible</span><br>
                    </div>
                    
                </div>
                <div class="increment">
                    <span class="moins2" onclick="prevNum1()">-</span><span id="valeur1"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum1()">+</span>
                </div>
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix" id="pt1">9000 </span><span class="cfa">FCFA</span></strong>
                </div>
                <div class="boutons">
...
<aside id="modal2" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/juro-jus-de-rone.jpg">
                    <div class="designation">
                        <span class="nom2">juro-jus-de-rone </span><br>
                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu2">1900</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibiliten">NON Disponible</span><br>
                    </div>
                    
                </div>
                <div class="increment">
                    <span class="moins2" onclick="prevNum2()">-</span><span id="valeur2"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum2()">+</span>
                </div>
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix"id="pt2">1900 </span><span class="cfa">FCFA</span></strong>
                </div>
                 <div class="boutons">
...
<aside id="modal3" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/jus-corosol-sans sucre.jpg">
                    <div class="designation">
                        <span class="nom2">jus-corosol-avec sucre </span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum3()">-</span><span id="valeur3"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum3()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal4" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                   <img src="images/jus-de-fruits/jus-de-baobab.jpg">
                    <div class="designation">
                        <span class="nom2">jus-de-baobab</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum4()">-</span><span id="valeur4"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum4()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal5" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                   <img src="images/jus-de-fruits/junabio-ananas.jpg">
                    <div class="designation">
                        <span class="nom2">junabio-ananas</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum5()">-</span><span id="valeur5"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum5()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal6" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/julado-ananas-gingembre.jpg">
                    <div class="designation">
                        <span class="nom2">julado-ananas-gingembre</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum6()">-</span><span id="valeur6"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum6()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal7" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                     <img src="images/jus-de-fruits/jus d_annas FIRSTLY1.jpg">
                    <div class="designation">
                        <span class="nom2">jus d'annas FIRSTLY</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum7()">-</span><span id="valeur7"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum7()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal8" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/Tropic jus mangue1.jpg">
                    <div class="designation">
                        <span class="nom2">Tropic jus mangue</span><br>
                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu8">1200</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibiliten">Non Disponible</span><br>
                    </div>
                    
                </div>
                <div class="increment">
                    <span class="moins2" onclick="prevNum8()">-</span><span id="valeur8"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum8()">+</span>
                </div>
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix" id="pt8">1200 </span><span class="cfa">FCFA</span></strong>
                </div>
                 <div class="boutons">
                    <div class="panier-ajout none"></div>
                    <div class="fermer js-modal-close ">FERMER</div>
...
<aside id="modal9" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/junabio-tamarin.jpg">
                    <div class="designation">
                        <span class="nom2">junabio-tamarin</span><br>                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu9">800</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibilite">Disponible</span><br>
                    </div>
                    
                </div>
                <div class="increment">
                    <span class="moins2" onclick="prevNum9()">-</span><span id="valeur9"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum9()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal10" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                     <img src="images/jus-de-fruits/junabio-gingembre.jpg">
                    <div class="designation">
                        <span class="nom2">junabio-gingembre</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum10()">-</span><span id="valeur10"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum10()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal11" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/floris-sirop-bissap(2).jpg">
                    <div class="designation">
                        <span class="nom2">floris-sirop-bissap</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum11()">-</span><span id="valeur11"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum11()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal12" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/Tropic jus ananas1.jpg">
                    <div class="designation">
                        <span class="nom2">Tropic jus ananas</span><br>
                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu12">2000</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibilite">Disponible</span><br>
                    </div>
                    
                </div>
                <div class="increment">
                    <span class="moins2" onclick="prevNum12()">-</span><span id="valeur12"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum12()">+</span>
                </div>
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix" id="pt12">2000</span><span class="cfa">FCFA</span></strong>
                </div>
                <div class="boutons">
                    <div class="panier-ajout js-modal-close">Ajouter au panier</div>
                    <div class="panier-details2"><a href="Mon panier.php">MON PANIER</a></div>
...
<aside id="modal13" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/florisjus-ginco-gingembre-cola.jpg" href="#modal13">
                    <div class="designation">
                        <span class="nom2">florisjus Ginco</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum13()">-</span><span id="valeur13"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum13()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal14" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/champinoni.jpg">
                    <div class="designation">
                        <span class="nom2">florisjus Ginco</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum14()">-</span><span id="valeur14"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum14()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal15" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                   <img src="images/jus-de-fruits/champinoni.jpg">
                    <div class="designation">
                        <span class="nom2">champinoni</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum15()">-</span><span id="valeur15"><span></span></span><strong>BTLS</strong></span><span class="plus2" onclick="nextNum15()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal17" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/junabio-ananas-gingembre.jpg">
                    <div class="designation">
                        <span class="nom2">junabio-ananas-gingembre</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum17()">-</span><span id="valeur17"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum17()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal18" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/jus-corosol-avec sucre.jpg">
                    <div class="designation">
                        <span class="nom2">jus-corosol-avec sucre </span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum18()">-</span><span id="valeur18"><span></span></span><strong>BTLS</strong><span class="plus2" onclick="nextNum18()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal19" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/jus-de-fruits/thera-champion.jpg" >
                    <div class="designation">
                        <span class="nom2">thera-champion</span><br>
                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu19">300</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibiliten">Non Disponible</span><br>
                    </div>
                    
                </div>
                <div class="increment">
                    <span class="moins2 prev" onclick="prevNum19()">-</span><span id="valeur19"><span></span></span><strong>BTLS</strong><span class="plus2 next" onclick="nextNum19()">+</span>
                </div>
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix"id="pt19"></span><span class="cfa">FCFA</span></strong>
                </div>
                 <div class="boutons">
                    <div class="panier-ajout none"></div>
                    <div class="fermer js-modal-close ">FERMER</div>
        ...
        <!---------- 1er container----------------------->
                   ...
                   <div class="produits-container">
                         ...
                         <div class="produits-box js-modal prod1" href="#modal1">
                                   ...
                                   <div class="produits-b-img js-modal prod1" href="#modal1">
                                     <img src="images/jus-de-fruits/l-ananas-presse-du-togo-100-pur-jus-fabrique-a-partir-d-ananas-frais1.jpg" href="#modal1" class="js-modal prod1">
                                                        </div>
                                         <div class="produits-b-text js-modal prod1" href="#modal1">
                                                 <strong style=" color: #15CD2B; "href="#modal1" class="js-modal prod2">ananas-presse</strong>
                                      ...
                                      <div class="produits-box js-modal prod1" href="#modal2">
                                                  ...
                                                  <div class="produits-b-img js-modal prod1" href="#modal2">
                                                       <img src="images/jus-de-fruits/juro-jus-de-rone.jpg" href="#modal2" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal2">
                                                            <strong style=" color: #15CD2B;"href="#modal2" class="js-modal prod2">juro-jus-de-rone </strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal2" class="js-modal prod3"> <strong href="#modal2" class="js-modal"> 1900 FCFA</strong> </p>
                                                        </div>
                                     ...
                                     <div class="produits-box js-modal prod1" href="#modal3">
                                                 ...
                                                 <div class="produits-b-img js-modal prod1" href="#modal3">
                                                         <img src="images/jus-de-fruits/jus-corosol-sans sucre.jpg" href="#modal3" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal3">
                                                            <strong style=" color: #15CD2B; "href="#modal3" class="js-modal prod2">jus-corosol-avec sucre </strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal3" class="js-modal prod3"> <strong href="#modal3" class="js-modal"> 900 FCFA</strong> </p>
                                                        </div>
                                                                <div class="en-stockr js-modal prod1" href="#modal3">
                                                                     <span><strong> <u href="#modal2" class="js-modal">Non en stock</u></strong> </span>
                              ...
                              <div class="produits-box js-modal prod1" href="#modal4">
                                                  ...
                                                  <div class="produits-b-img js-modal prod1" href="#modal4">
                                                    <img src="images/jus-de-fruits/jus-de-baobab.jpg" href="#modal4" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal4">
                                                            <strong style=" color: #15CD2B;"href="#modal4" class="js-modal prod2">jus-de-baobab</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal4" class="js-modal prod3"> <strong href="#modal4" class="js-modal"> 1000 FCFA</strong> </p>
                                                        </div>
                                                                <div class="en-stockr js-modal prod1" href="#modal4">
                                                                     <span><strong> <u href="#modal4" class="js-modal">Non en stock</u></strong> </span>
                        ...
                        <div  class="produits-container">
                                    <div class="produits-box js-modal prod1" href="#modal5">
                                            ...
                                            <div class="produits-b-img js-modal prod1" href="#modal5">
                                                <img src="images/jus-de-fruits/junabio-ananas.jpg" href="#modal5" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal5">
                                                            <strong style=" color: #15CD2B;"href="#modal5" class="js-modal prod2">junabio-ananas</strong>
         ...
         <div class="produits-box js-modal prod1" href="#modal6">
                                                ...
                                                <div class="produits-b-img js-modal prod1" href="#modal6">
                                                       <img src="images/jus-de-fruits/julado-ananas-gingembre.jpg" href="#modal6" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal6">
                                                            <strong style=" color: #15CD2B; "href="#modal6" class="js-modal prod2">julado-ananas-gingembre</strong>
         ...
         <div class="produits-box js-modal prod1" href="#modal7">
                                                ...
                                                <div class="produits-b-img js-modal prod1" href="#modal7">
                                                      <img src="images/jus-de-fruits/jus d_annas FIRSTLY1.jpg" href="#modal7" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal7">
                                                            <strong style=" color: #15CD2B;"href="#modal7" class="js-modal prod2">jus d'annas FIRSTLY</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal7" class="js-modal prod3"> <strong href="#modal4" class="js-modal"> 1200 FCFA</strong> </p>
                                                                ...
                                                                <div class="en-stockr js-modal prod1" href="#modal7">
                                                                     <span><strong> <u href="#modal7" class="js-modal">Non en stock</u></strong> </span>
         ...
         <div class="produits-box js-modal prod1" href="#modal8">
                                               ...
                                               <div class="produits-b-img js-modal prod1" href="#modal8">
                                                    <img src="images/jus-de-fruits/Tropic jus mangue1.jpg" href="#modal8" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal8">
                                                            <strong style=" color: #15CD2B;"href="#modal8" class="js-modal prod2">Tropic jus mangue</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal8" class="js-modal prod3"> <strong href="#modal8" class="js-modal"> 1200 FCFA</strong> </p>
                                                        </div>
                        ...
                        <!---------- 3eme container----------------------->
                            ...
                            <div  class="produits-container">
                                        ...
                                        <div class="produits-box js-modal prod1" href="#modal9">
                                            ...
                                            <img src="images/jus-de-fruits/junabio-tamarin.jpg" href="#modal9" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal9">
                                                            <strong style=" color: #15CD2B;"href="#modal9" class="js-modal prod2">junabio-tamarin</strong>
         ...
         <div class="produits-box js-modal prod1" href="#modal10">
                                              ...
                                              <div class="produits-b-img js-modal prod1" href="#modal10">
                                                    <img src="images/jus-de-fruits/junabio-gingembre.jpg" href="#modal10" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal10">
                                                            <strong style=" color: #15CD2B; "href="#modal10" class="js-modal prod2">junabio-gingembre</strong>
         ...
         <div class="produits-box js-modal prod1" href="#modal11">
                                             ...
                                             <div class="produits-b-img js-modal prod1" href="#modal11">
                                                      <img src="images/jus-de-fruits/floris-sirop-bissap(2).jpg" href="#modal11" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal11">
                                                            <strong style=" color: #15CD2B; "href="#modal11" class="js-modal prod2">floris-sirop-bissap</strong>
         ...
         <div class="produits-box js-modal prod1" href="#modal12">
                                               ...
                                               <div class="produits-b-img js-modal prod1" href="#modal12">
                                                  <img src="images/jus-de-fruits/Tropic jus ananas1.jpg" href="#modal12" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal12">
                                                            <strong style=" color: #15CD2B; "href="#modal12" class="js-modal prod2">Tropic jus ananas</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal12" class="js-modal prod3"> <strong href="#modal12" class="js-modal"> 2000 FCFA</strong> </p>
                                                        </div>
                        ...
                        <div  class="produits-container">
                                ...
                                <div class="produits-box js-modal prod1" href="#modal13">
                                               ...
                                               <div class="produits-b-img js-modal prod1" href="#modal13">
                                                    <img src="images/jus-de-fruits/florisjus-ginco-gingembre-cola.jpg" href="#modal13" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal13">
                                                            <strong style=" color: #15CD2B; "href="#modal13" class="js-modal prod2">florisjus Ginco</strong>
         ...
         <div class="produits-box js-modal prod1" href="#modal14">
                                                        ...
                                                        <div class="produits-b-img js-modal prod1" href="#modal14">
                                                            <img src="images/jus-de-fruits/champinoni.jpg" href="#modal14" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal14">
                                                            <strong style=" color: #15CD2B;"href="#modal14" class="js-modal prod2">florisjus Ginco</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal14" class="js-modal prod3"> <strong href="#modal14" class="js-modal"> 900 FCFA</strong> </p>
                                                                ...
                                                                <div class="en-stockr js-modal prod1" href="#modal14">
                                                                     <span><strong> <u href="#modal14" class="js-modal">Non en stock</u></strong> </span>
         ...
         <div class="produits-box js-modal prod1" href="#modal15">
                                                ...
                                                <div class="produits-b-img js-modal prod1" href="#modal15">
                                                       <img src="images/jus-de-fruits/champinoni.jpg" href="#modal15" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal15">
                                                            <strong style=" color: #15CD2B; "href="#modal15" class="js-modal prod2">champinoni</strong>
                        ...
                        <div  class="produits-container">
                                    ...
                                    <div class="produits-box js-modal prod1" href="#modal17">
                                                        ...
                                                        <div class="produits-b-img js-modal prod1" href="#modal17">
                                                            <img src="images/jus-de-fruits/junabio-ananas-gingembre.jpg" href="#modal17" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal17">
                                                            <strong style=" color: #15CD2B; "href="#modal17" class="js-modal prod2">junabio-ananas-gingembre</strong>
         ...
         <div class="produits-box js-modal prod1" href="#modal18">
                                                ...
                                                <div class="produits-b-img js-modal prod1" href="#modal18">
                                                       <img src="images/jus-de-fruits/jus-corosol-avec sucre.jpg" href="#modal18" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal18">
                                                            <strong style=" color: #15CD2B; "href="#modal18" class="js-modal prod2">jus-corosol-avec sucre </strong>
         ...
         <div class="produits-box js-modal prod1" href="#modal19">
                                                        ...
                                                        <div class="produits-b-img js-modal prod1" href="#modal19">
                                                           <img src="images/jus-de-fruits/thera-champion.jpg" href="#modal19" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal19">
                                                            <strong style=" color: #15CD2B; "href="#modal19" class="js-modal prod2">thera-champion</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal19" class="js-modal prod3"> <strong href="#modal19" class="js-modal"> 300 FCFA</strong> </p>
                                                        </div>
