...
<aside id="modal1" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/épicerie/ail2.jpg">
...
<aside id="modal2" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/épicerie/Atingali4.png">
                    <div class="designation">
                        <span class="nom2">Atingali (250g)</span><br>
                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu2">900</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibilite">Disponible</span><br>
                    </div>
                ...
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix"id="pt2">900 </span><span class="cfa">FCFA</span></strong>
                </div>
                <div class="boutons">
...
<aside id="modal3" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/épicerie/P1040199.png">
                    <div class="designation">
                        <span class="nom2">Abaloua (250g) </span><br>
 ...
 <aside id="modal5" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                   <img src="images/épicerie/Ayikou1.jpg">
                    <div class="designation">
                        <span class="nom2">Ayikou (250g)</span><br>
...
<aside id="modal6" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/épicerie/clou de gironfle3.jpg">
                    <div class="designation">
                        <span class="nom2">Clou de gironfle (250g)</span><br>
...
<aside id="modal7" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                     <img src="images/divers/poivre.png">
                    <div class="designation">
                        <span class="nom2">Poivre noire</span><br>
                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu7">1900</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibilite">Disponible</span><br>
                    </div>
                ...
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix" id="pt7">1900 </span><span class="cfa">FCFA</span></strong>
                </div>
                <div class="boutons">
                    <div class="panier-ajout js-modal-close">AJOUTER AU PANIER</div>
                    <div class="panier-details2"><a href="Mon panier.php">MON PANIER</a></div>
...
<aside id="modal9" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/épicerie/curcuma.jpg">
                    <div class="designation">
                        <span class="nom2">Curcuma poudre (250g)</span><br>
                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu9">300</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibilite">Disponible</span><br>
                    </div>
                ...
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix" id="pt9">300 </span><span class="cfa">FCFA</span></strong>
                </div>
                <div class="boutons">
                    <div class="none"></div>
                    <div class="panier-ajout  js-modal-close ">AJOUTER AU PANIER</div>
...
<aside id="modal10" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                     <img src="images/épicerie/gingembre-1.jpg">
                    <div class="designation">
                        <span class="nom2">Gingembre (250g)</span><br>
...
<aside id="modal13" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/épicerie/Poivre rouge3.png" href="#modal13">
                    <div class="designation">
                        <span class="nom2">Poivre rouge (250g)</span><br>
...
<aside id="modal14" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/épicerie/P1040189.png">
                    <div class="designation">
                        <span class="nom2">AAAAAA (250g)</span><br>
...
<aside id="modal17" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/épicerie/Poivre Noire2.png">
                    <div class="designation">
                        <span class="nom2">Poivre Noire (250g)</span><br>
                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu17">250</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibilite">Disponible</span><br>
                    </div>
                ...
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix" id="pt17">250</span><span class="cfa">FCFA</span></strong>
                </div>
                <div class="boutons">
                    <div class="panier-ajout js-modal-close">AJOUTER AU PANIER</div>
                    <div class="panier-details2"><a href="Mon panier.php">MON PANIER</a></div>
...
<aside id="modal18" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/épicerie/piment-de-Cayenne.jpg">
                    <div class="designation">
                        <span class="nom2">Piment poudre (300g) </span><br>
        ...
        <!---------- 1er container----------------------->
                   ...
                   <div class="produits-container">
                         ...
                         <div class="produits-box js-modal prod1" href="#modal1">
                                   ...
                                   <div class="produits-b-img js-modal prod1" href="#modal1">
                                     <img src="images/épicerie/ail2.jpg" href="#modal1" class="js-modal prod1">
                                                        </div>
                                      ...
                                      <div class="produits-box js-modal prod1" href="#modal2">
                                                  ...
                                                  <div class="produits-b-img js-modal prod1" href="#modal2">
                                                       <img src="images/épicerie/Atingali4.png" href="#modal2" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal2">
                                                            <strong style=" color: #15CD2B; "href="#modal2" class="js-modal prod2">Atingali (250g) </strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal2" class="js-modal prod3"> <strong href="#modal2" class="js-modal"> 900 FCFA</strong> </p>
                                                        </div>
                                     ...
                                     <div class="produits-box js-modal prod1" href="#modal3">
                                                 ...
                                                 <div class="produits-b-img js-modal prod1" href="#modal3">
                                                         <img src="images/épicerie/P1040199.png" href="#modal3" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal3">
                                                            <strong style=" color: #15CD2B;"href="#modal3" class="js-modal prod2">Abaloua (250g) </strong>
                        ...
                        <div  class="produits-container">
                                    <div class="produits-box js-modal prod1" href="#modal5">
                                            ...
                                            <div class="produits-b-img js-modal prod1" href="#modal5">
                                                <img src="images/épicerie/Ayikou1.jpg" href="#modal5" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal5">
                                                            <strong style=" color: #15CD2B; "href="#modal5" class="js-modal prod2">Ayikou (250g)</strong>
         ...
         <div class="produits-box js-modal prod1" href="#modal6">
                                                ...
                                                <div class="produits-b-img js-modal prod1" href="#modal6">
                                                       <img src="images/épicerie/clou de gironfle3.jpg" href="#modal6" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal6">
                                                            <strong style=" color: #15CD2B; "href="#modal6" class="js-modal prod2">Clou de gironfle (250g)</strong>
         ...
         <div class="produits-box js-modal prod1" href="#modal7">
                                                ...
                                                <div class="produits-b-img js-modal prod1" href="#modal7">
                                                      <img src="images/divers/poivre.png" href="#modal7" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal7">
                                                            <strong style=" color: #15CD2B;"href="#modal7" class="js-modal prod2">Poivre noire</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal7" class="js-modal prod3"> <strong href="#modal4" class="js-modal"> 1900 FCFA</strong> </p>
                                                        </div>
                        ...
                        <!---------- 3eme container----------------------->
                            ...
                            <div  class="produits-container">
                                        ...
                                        <div class="produits-box js-modal prod1" href="#modal9">
                                            ...
                                            <img src="images/épicerie/curcuma.jpg" href="#modal9" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal9">
                                                            <strong style=" color: #15CD2B; "href="#modal9" class="js-modal prod2">Curcuma poudre (250g)</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal9" class="js-modal prod3"> <strong href="#modal9" class="js-modal"> 300 FCFA</strong> </p>
                                                        </div>
         ...
         <div class="produits-box js-modal prod1" href="#modal10">
                                              ...
                                              <div class="produits-b-img js-modal prod1" href="#modal10">
                                                    <img src="images/épicerie/gingembre-1.jpg" href="#modal10" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal10">
                                                            <strong style=" color: #15CD2B; "href="#modal10" class="js-modal prod2">Gingembre (250g)</strong>
                        ...
                        <div  class="produits-container">
                                ...
                                <div class="produits-box js-modal prod1" href="#modal13">
                                               ...
                                               <div class="produits-b-img js-modal prod1" href="#modal13">
                                                    <img src="images/épicerie/Poivre rouge3.png" href="#modal13" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal13">
                                                            <strong style=" color: #15CD2B; "href="#modal13" class="js-modal prod2">Poivre rouge (250g)</strong>
         ...
         <div class="produits-box js-modal prod1" href="#modal14">
                                                        ...
                                                        <div class="produits-b-img js-modal prod1" href="#modal14">
                                                            <img src="images/épicerie/P1040189.png" href="#modal14" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal14">
                                                            <strong style=" color: #15CD2B;"href="#modal14" class="js-modal prod2">AAAAAA (250g)</strong>
                        ...
                        <div  class="produits-container">
                                    ...
                                    <div class="produits-box js-modal prod1" href="#modal17">
                                                        ...
                                                        <div class="produits-b-img js-modal prod1" href="#modal17">
                                                            <img src="images/épicerie/Poivre Noire2.png" href="#modal17" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal17">
                                                            <strong style=" color: #15CD2B; "href="#modal17" class="js-modal prod2">Poivre Noire (250g)</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal17" class="js-modal prod3"> <strong href="#modal17" class="js-modal"> 250 FCFA</strong> </p>
                                                        </div>
         ...
         <div class="produits-box js-modal prod1" href="#modal18">
                                                ...
                                                <div class="produits-b-img js-modal prod1" href="#modal18">
                                                       <img src="images/épicerie/piment-de-Cayenne.jpg" href="#modal18" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal18">
                                                            <strong style=" color: #15CD2B;"href="#modal18" class="js-modal prod2">Piment poudre (300g) </strong>
    ...
    <img src="images/épicerie/épicerie.jpg"  class="pref-img">
    </section>
