...
<body>
  ...
  <section id="produits" >
    <div class="produits-headings">
        <h1 class="produits-heading"><strong>NOS CÉRÉALES </strong></h1>
        <!-- bouton de recherche---->
        <form >
...
<aside id="modal1" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/céréals/Mais jaune.jfif">
                    <div class="designation">
                        <span class="nom2">Mais jaune (1bol)</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum1()">-</span><span id="valeur1"><span></span></span><strong>bol</strong><span class="plus2" onclick="nextNum1()">+</span>
                </div>
...
<aside id="modal2" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/céréals/Haricots.png">
                    <div class="designation">
                        <span class="nom2">Haricot (1bol) </span><br>
                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu2">1100</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibilite">Disponible</span><br>
                    </div>
                    
                </div>
                <div class="increment">
                    <span class="moins2" onclick="prevNum2()">-</span><span id="valeur2"><span></span></span><strong>bol</strong><span class="plus2" onclick="nextNum2()">+</span>
                </div>
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix"id="pt2">1100 </span><span class="cfa">FCFA</span></strong>
                </div>
                <div class="boutons">
...
<aside id="modal5" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                   <img src="images/céréals/mil.jfif">
                    <div class="designation">
                        <span class="nom2">Mil (1bol)</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum5()">-</span><span id="valeur5"><span></span></span><strong>bol</strong><span class="plus2" onclick="nextNum5()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal6" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/céréals/Faunio.jfif">
                    <div class="designation">
                        <span class="nom2">Fonio (1bol)</span><br>
                       <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu6">2000</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibiliten"> Non Disponible</span><br>
                    </div>
                    
                </div>
                <div class="increment">
                    <span class="moins2" onclick="prevNum6()">-</span><span id="valeur6"><span></span></span><strong>bol</strong><span class="plus2" onclick="nextNum6()">+</span>
                </div>
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix" id="pt6">2000 </span><span class="cfa">FCFA</span></strong>
                </div>
                <div class="boutons">
...
<aside id="modal9" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/céréals/sodja.png">
                    <div class="designation">
                        <span class="nom2">Sodja (1bol)</span><br>
                ...
                <div class="increment">
                    <span class="moins2" onclick="prevNum9()">-</span><span id="valeur9"><span></span></span><strong>bol</strong><span class="plus2" onclick="nextNum9()">+</span>
                </div>
                <div class="prix-totald">
...
<aside id="modal10" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                     <img src="images/céréals/Riz-couscous2.jpg">
                    <div class="designation">
                        <span class="nom2">Riz couscous (1bol)</span><br>
                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu10">1400</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibilite">Disponible</span><br>
                    </div>
                    
                </div>
                <div class="increment">
                    <span class="moins2" onclick="prevNum10()">-</span><span id="valeur10"><span></span></span><strong>bol</strong><span class="plus2" onclick="nextNum10()">+</span>
                </div>
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix" id="pt10">1400 </span><span class="cfa">FCFA</span></strong>
                </div>
                <div class="boutons">
                    <div class="panier-ajout js-modal-close">AJOUTER AU PANIER</div>
                    <div class="panier-details2"><a href="Mon panier.php">MON PANIER</a></div>
...
<aside id="modal13" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/céréals/poids_d_angole.png" href="#modal13">
                    <div class="designation">
                        <span class="nom2">Poids d'angole (1bol) </span><br>
                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu13">2000</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibiliten">Non Disponible</span><br>
                    </div>
                    
                </div>
                <div class="increment">
                    <span class="moins2" onclick="prevNum13()">-</span><span id="valeur13"><span></span></span><strong>bol</strong><span class="plus2" onclick="nextNum13()">+</span>
                </div>
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix" id="pt13">2000 </span><span class="cfa">FCFA</span></strong>
                </div>
                <div class="boutons">
                    <div class="panier-ajout none"></div>
                    <div class="fermer js-modal-close">FERMER</div>
...
<aside id="modal17" class="modal" aria-hidden="true" role="dialog" style="display: none;">
            ...
            <div class="modal-wrapper js-modal-stop">
                <div class="modal-wrapper-inf-im">
                    <img src="images/céréals/Arachide.jpg">
                    <div class="designation">
                        <span class="nom2">Arachide (1bol)</span><br>
                        <strong class="units-prix">Prix unitaire:</strong><span class="unit-prix" id="pu17">1300</span><span class="unit-prix"> FCFA</span><br>
                        <span class="disponibilite">Disponible</span><br>
                    </div>
                    
                </div>
                <div class="increment">
                    <span class="moins2" onclick="prevNum17()">-</span><span id="valeur17"><span></span></span><strong>bol</strong><span class="plus2" onclick="nextNum17()">+</span>
                </div>
                <div class="prix-totald">
                    <strong><span class="prix-total">PRIX TOTAL:</span><span class="totalpprix" id="pt17">1300 </span><span class="cfa">FCFA</span></strong>
                </div>
                <div class="boutons">
                    <div class="panier-ajout js-modal-close">AJOUTER AU PANIER</div>
                    <div class="panier-details2"><a href="Mon panier.php">MON PANIER</a></div>
        ...
        <!---------- 1er container----------------------->
                   ...
                   <div class="produits-container">
                                ...
                                <div class="produits-box js-modal prod1" href="#modal1">
                                                        ...
                                                        <div class="produits-b-img js-modal prod1" href="#modal1">
                                                            <img src="images/céréals/Mais jaune.jfif" href="#modal1" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal1">
                                                           <strong style=" color: #15CD2B; "href="#modal1" class="js-modal prod2">Mais jaune (1bol)</strong>
                                      ...
                                      <div class="produits-box js-modal prod1" href="#modal2">
                                                  ...
                                                  <div class="produits-b-img js-modal prod1" href="#modal2">
                                                       <img src="images/céréals/Haricots.png" href="#modal2" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal2">
                                                            <strong style=" color: #15CD2B; "href="#modal2" class="js-modal prod2">Haricot (1bol)</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal2" class="js-modal prod3"> <strong href="#modal2" class="js-modal"> 1 100 FCFA</strong> </p>
                                                        </div>
                        ...
                        <div  class="produits-container">
                                    <div class="produits-box js-modal prod1" href="#modal5">
                                                ...
                                                <div class="produits-b-img js-modal prod1" href="#modal5">
                                                    <img src="images/céréals/mil.jfif" href="#modal5" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal5">
                                                            <strong style=" color: #15CD2B; "href="#modal5" class="js-modal prod2">Mil (1bol)</strong>
                           ...
                           <div class="produits-box js-modal prod1" href="#modal6">
                                                ...
                                                <div class="produits-b-img js-modal prod1" href="#modal6">
                                                       <img src="images/céréals/Faunio.jfif" href="#modal6" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal6">
                                                            <strong style=" color: #15CD2B; "href="#modal6" class="js-modal prod2">Fonio (1bol)</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal6" class="js-modal prod3"> <strong href="#modal6" class="js-modal"> 2 000 FCFA</strong> </p>
                                                        </div>
                                                                <div class="en-stockr js-modal prod1" href="#modal4">
                                                                     <span><strong> <u href="#modal6" class="js-modal">Non en stock</u></strong> </span>
                            ...
                            <div  class="produits-container">
                                        ...
                                        <div class="produits-box js-modal prod1" href="#modal9">
                                                 ...
                                                 <div class="produits-b-img js-modal prod1" href="#modal9">
                                                       <img src="images/céréals/sodja.png" href="#modal9" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal9">
                                                            <strong style=" color: #15CD2B; "href="#modal9" class="js-modal prod2">Sodja (1bol)</strong>
             ...
             <div class="produits-box js-modal prod1" href="#modal10">
                                              ...
                                              <div class="produits-b-img js-modal prod1" href="#modal10">
                                                    <img src="images/céréals/Riz-couscous2.jpg" href="#modal10" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal10">
                                                            <strong style=" color: #15CD2B;"href="#modal10" class="js-modal prod2">Riz couscous (1bol)</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal10" class="js-modal prod3"> <strong href="#modal10" class="js-modal"> 1400 FCFA</strong> </p>
                                                        </div>
                        ...
                        <div  class="produits-container">
                                ...
                                <div class="produits-box js-modal prod1" href="#modal13">
                                               ...
                                               <div class="produits-b-img js-modal prod1" href="#modal13">
                                                    <img src="images/céréals/poids_d_angole.png" href="#modal13" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal13">
                                                            <strong style=" color: #15CD2B; "href="#modal13" class="js-modal prod2">Poids d'angole (1bol) </strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal13" class="js-modal prod3"> <strong href="#modal13" class="js-modal"> 2000 FCFA</strong> </p>
                                                        </div>
                        ...
                        <div  class="produits-container">
                                    ...
                                    <div class="produits-box js-modal prod1" href="#modal17">
                                                        ...
                                                        <div class="produits-b-img js-modal prod1" href="#modal17">
                                                            <img src="images/céréals/Arachide.jpg" href="#modal17" class="js-modal prod1">
                                                        </div>
                                                        <div class="produits-b-text js-modal prod1" href="#modal17">
                                                            <strong style=" color: #15CD2B; "href="#modal17" class="js-modal prod2">Arachide (1bol)</strong>
                                                            <p align="center" style="margin-top: 4px;" href="#modal17" class="js-modal prod3"> <strong href="#modal17" class="js-modal"> 1 300 FCFA</strong> </p>
                                                        </div>
        ...
        <!---------- 1er container----------------------->
           ...
           <div class="bas-de-page2">
                    <div class="ul-div">
                       ...
                       <li class="check"><a href="boulangerie_page2.php">2</a></li>

                       <li class="check"><a href="boulangerie_page3.php">3</a></li>---
                        <li class="check"><a href="boulangerie_page4.php">4</a></li>
                        <li class="checked"><a href="boulangerie_page3.php"><strong>>></strong></a></li>--->
                      </ul>
                    </div>
                     <div class="bas-div2">
...
<script src="js/cereale.js" ></script>
