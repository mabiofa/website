...
document.querySelectorAll('.js-modal').forEach(a => {
  ...
  let modal1=null;
  const openModal1 = function (product){
    
  product.preventDefault();
    const target1=document.querySelector(product.target.getAttribute('href'));
    
    target1.style.display = null;
    target1.setAttribute('arial-modal','true');
    target1.removeAttribute('arial-hidden');
    modal1=target1;
    modal1.addEventListener('click',closeModal1);
    modal1.querySelector('.js-modal-close1').addEventListener('click', closeModal1);
    modal1.querySelector('.js-modal-stop1').addEventListener('click', stopPropagation);
    func5();
    func6();
  }
  ...
  e.preventDefault();
    ...
    modal1.removeAttribute('arial-modal');
    modal1.setAttribute('arial-hidden','true');
  
    modal1.removeEventListener('click',closeModal);
    modal1.querySelector('.js-modal-close1').removeEventListener('click', closeModal1);
    modal1.querySelector('.js-modal-stop1').removeEventListener('click', stopPropagation);
    modal1=null;
    func5();
    func6();
  }
