...
let products = [
    {icrement:1,
  name:'panier bio de légumes familly xl',
  tag:"panier bio de légumes familly xl",
  image:'Panier famille/panier de légumes familly xl.jpg',
  prix:0,
  prixu:400,
  incart:0},
   {icrement:1,
  name:'pannier bio légumes familly xxl',
  tag:"pannier bio légumes familly xxl",
  image:'Panier famille/pannier légumes familly xxl.jfif',
  prix:0,
  prixu:400,
  incart:0},
/*
...
*/
  {icrement:1,
  name:'panier légumes aniversaires',
  tag:"panier légumes aniversaires",
  image:'Panier famille/panier  légumes aniversaires1.jfif',
  prix:0,
  prixu:400,
  incart:0},
/*
...
*/
  {icrement:1,
  name:'panier familly mixte (légumes/fruits)',
  tag:"panier familly mixte (légumes/fruits)",
  image:'Panier famille/panier familly mixte (légumes _ fruits).jfif',
  prix:0,
  prixu:400,
  incart:0},
/*
