...
let products = [
    {icrement:1,
  name:'Poivrons rouge (1Kg)',
  tag:"Poivrons rouge (1Kg)",
  image:'légumes/poivrons-rouges2.jfif',
  prix:0,
  prixu:1100,
  incart:0},
   {icrement:0.5,
  name:'Radis (1/2Kg)',
  tag:"Radis (1/2Kg)",
  image:'légumes/Radi.jfif',
  prix:0,
  prixu:350,
  incart:0},

  {icrement:0.5,
  name:'Poivrons jaune (1/2Kg)',
  tag:"Poivrons jaune (1/2Kg)",
  image:'légumes/poivrons-jaunes.png',
  prix:0,
  prixu:600,
  incart:0},
  ...
  name:'Lauchs (1/2Kg)',
  tag:"Lauchs (1/2Kg)",
  image:'légumes/Lauchs.jpg',
  prix:0,
  prixu:500,
  incart:0},

  {icrement:0.5,
  name:'Salade verte (1/2Kg)',
  tag:"Salade verte (1/2Kg)",
  image:'légumes/salade-verte.png',
  prix:0,
  prixu:500,
  incart:0},

  {icrement:0.5,
  name:'Haricot vert (1/2Kg)',
  tag:"Haricot vert (1/2Kg)",
  image:'légumes/haricot vert4.jfif',
  prix:0,
  prixu:600,
  incart:0},

  {icrement:0.5,
  name:'Petit pois (1/2Kg)',
  tag:"Petit pois (1/2Kg)",
  image:'légumes/petit pois1.jfif',
  prix:0,
  prixu:500,
  incart:0},
  ...
  name:'Courgettes (1Kg)',
  tag:"Courgettes (1Kg)",
  image:'légumes/courgettes2.jfif',
  prix:0,
  prixu:700,
  incart:0},

  {icrement:1,
  name:'Gombo Kirikou (1Kg)',
  tag:"Gombo Kirikou (1Kg)",
  image:'légumes/Gombo_kirikou2.jfif',
  prix:0,
  prixu:900,
  incart:0},

  {icrement:1,
  name:'Banane plantain vert (1Kg)',
  tag:"Banane plantain vert (1Kg)",
  image:'légumes/Banane plantain vert.jfif',
  prix:0,
  prixu:1200,
  incart:0},
  ...
  image:'Oignons-bruns.jpg',
  prix:0,
  prixu:1000,
  incart:0},

  {icrement:0.5,
  name:'piment long vert (1/2Kg)',
  tag:"piment long vert (1/2Kg)",
  image:'légumes/piment long vert.jpg',
  prix:0,
  prixu:550,
  incart:0},

  {icrement:1,
  name:'Plantains semi-mure (1Kg)',
  tag:"Plantains semi-mure (1Kg)",
  image:'légumes/Banane plantain semi mure1.jfif',
  prix:0,
  prixu:1000,
  incart:0},

  {icrement:0.5,
  name:'Tomates Mongales (1/2Kg)',
  tag:"Tomates Mongales (1/2Kg)",
  image:'légumes/Tomates6.jpg',
  prix:0,
  prixu:900,
  incart:0},
  ...
  {icrement:1,
  name:'Plantains mures (1Kg)',
  tag:"Plantains mures (1Kg)",
  image:'légumes/Banane plantain mure1.jfif',
  prix:0,
  prixu:900,
  incart:0},
  ...
  tag:"pomme de terre (1Kg)",
  image:'légumes/pomme de terre8.jpg',
  prix:0,
  prixu:1000,
  incart:0},
  ...
  image:'piment Gboébéssé vert.jpg',
  prix:0,
  prixu:650,
  incart:0}
...
/*partie js pour ajout de produit---------------*/
            ...
            var number20= document.getElementById('valeur20');
               ...
               span1.textContent =i;
                   ...
                   span5.textContent =i*0.5;
                   span6.textContent =i*0.5;
                   span7.textContent =i*0.5;
                   span8.textContent =i*0.5;
                   span9.textContent =i;
                   span10.textContent =i;
                   span11.textContent =i;
                   span12.textContent =i;
                   span13.textContent =i*0.5;
...
console.log(index12);
totalprice();
console.log(parseInt(price5.textContent));
