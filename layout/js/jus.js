...
let products = [
  ...
  name:'ananas-presse',
  tag:"ananas-presse",
  image:'Boissons/jus/l-ananas-presse-du-togo-100-pur-jus-fabrique-a-partir-d-ananas-frais1.jpg',
  prix:0,
  prixu:9000,
  incart:0},
   {icrement:1,
  name:'juro-jus-de-rone',
  tag:"juro-jus-de-rone",
  image:'Boissons/jus/juro-jus-de-rone.jpg',
  prix:0,
  prixu:1900,
  incart:0},

  {icrement:1,
  name:'jus-corosol-avec sucre ',
  tag:"jus-corosol-avec sucre ",
  image:'Boissons/jus/jus-corosol-sans sucre.jpg',
  prix:0,
  prixu:900,
  incart:0},
  ...
  name:'jus-de-baobab',
  tag:"jus-de-baobab",
  image:'Boissons/jus/jus-de-baobab.jpg',
  prix:0,
  prixu:1000,
  incart:0},
  ...
  name:'junabio-ananas',
  tag:"junabio-ananas",
  image:'Boissons/jus/junabio-ananas.jpg',
  prix:0,
  prixu:900,
  incart:0},

  {icrement:1,
  name:'julado-ananas-gingembre',
  tag:"julado-ananas-gingembre",
  image:'Boissons/jus/julado-ananas-gingembre.jpg',
  prix:0,
  prixu:900,
  incart:0},

  {icrement:1,
  name:'jus d\'annas FIRSTLY',
  tag:"jus d'annas FIRSTLY",
  image:'Boissons/jus/jus d_annas FIRSTLY1.jpg',
  prix:0,
  prixu:1200,
  incart:0},

  {icrement:1,
  name:'Tropic jus mangue',
  tag:"Tropic jus mangue",
  image:'Boissons/jus/Tropic jus mangue1.jpg',
  prix:0,
  prixu:1200,
  incart:0},

  {icrement:1,
  name:'junabio-tamarin',
  tag:"junabio-tamarin",
  image:'Boissons/jus/junabio-tamarin.jpg',
  prix:0,
  prixu:800,
  incart:0},

  {icrement:1,
  name:'junabio-gingembre',
  tag:"junabio-gingembre",
  image:'Boissons/jus/junabio-gingembre.jpg',
  prix:0,
  prixu:1000,
  incart:0},

  {icrement:1,
  name:'floris-sirop-bissap',
  tag:"floris-sirop-bissap",
  image:'Boissons/jus/floris-sirop-bissap(2).jpg',
  prix:0,
  prixu:2000,
  incart:0},

  {icrement:1,
  name:'Tropic jus ananas',
  tag:"Tropic jus ananas",
  image:'Boissons/jus/Tropic jus ananas1.jpg',
  prix:0,
  prixu:2000,
  incart:0},

  {icrement:1,
  name:'florisjus Ginco',
  tag:"florisjus Ginco",
  image:'Boissons/jus/florisjus-ginco-gingembre-cola.jpg',
  prix:0,
  prixu:1500,
  incart:0},
  ...
  name:'florisjus Ginco',
  tag:"florisjus Ginco",
  image:'Boissons/jus/champinoni.jpg',
  prix:0,
  prixu:900,
  incart:0},
...
*/
  {icrement:1,
  name:'junabio-ananas-gingembre',
  tag:"junabio-ananas-gingembre",
  image:'Boissons/jus/junabio-ananas-gingembre.jpg',
  prix:0,
  prixu:1100,
  incart:0},
  ...
  name:'jus-corosol-avec sucre',
  tag:"jus-corosol-avec sucre ",
  image:'Boissons/jus/jus-corosol-avec sucre.jpg',
  prix:0,
  prixu:300,
  incart:0},
  ...
  name:'thera-champion',
  tag:"thera-champion",
  image:'Boissons/jus/thera-champion.jpg',
  prix:0,
  prixu:300,
  incart:0},
/*
...
let a=0;
  function setItems(product){
    ...
    product.prix=parseInt(price1.textContent)+parseInt(price2.textContent)+parseInt(price3.textContent)+parseInt(price4.textContent)+parseInt(price5.textContent)
      ...
      +parseInt(price12.textContent)+parseInt(price13.textContent)+parseInt(price14.textContent)+parseInt(price15.textContent)//+parseInt(price16.textContent)
    ...
    if (cartItems != null && product.prix!=0) {
      ...
      index11+index12+index13+index14+index15//+index16
...
/*partie js pour ajout de produit---------------*/
  ...
  product.preventDefault();
   ...
   index1=0;index2=0;index3=0;index4=0;index5=0;index6=0;index7=0;index8=0;index9=0;index10=0;
    index11=0;index12=0;index13=0;index14=0;index15=0;//index16=0;
