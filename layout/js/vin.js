...
let products = [
  ...
  name:'blanco-saveur-cannelle',
  tag:"blanco-saveur-cannelle",
  image:'Boissons/vin alcool/blanco-saveur-cannelle.jpg',
  prix:0,
  prixu:9000,
  incart:0},
   {icrement:1,

  name:'blanco-saveur-clou-de-girofle',
  tag:"blanco-saveur-clou-de-girofle",
  image:'Boissons/vin alcool/blanco-saveur-clou-de-girofle.jpg',
  prix:0,
  prixu:900,
  incart:0},
  ...
  name:'cerry-dry ',
  tag:"cerry-dry ",
  image:'Boissons/vin alcool/cerry-dry.jpg',
  prix:0,
  prixu:700,
  incart:0},
  ...
  name:'blanco-saveur-clou-de-girofle',
  tag:"blanco-saveur-clou-de-girofle",
  image:'Boissons/vin alcool/chateau-montet-bordeaux-rouge-2015.jpg',
  prix:0,
  prixu:1000,
  incart:0},
  ...
  name:'caliendi-liqueur',
  tag:"caliendi-liqueur",
  image:'Boissons/vin alcool/caliendi-liqueur.jpg',
  prix:0,
  prixu:600,
  incart:0},
  ...
  name:'old-man-edv-ob',
  tag:"old-man-edv-ob",
  image:'Boissons/vin alcool/eau-de-vie-originale-blanc-black-old-man-edv-ob.jpg',
  prix:0,
  prixu:900,
  incart:0},
  ...
  name:'haut-guillebot 2017',
  tag:"haut-guillebot 2017",
  image:'Boissons/vin alcool/chateau-haut-guillebot-bordeaux-supérieur-2017.jpg',
  prix:0,
  prixu:1200,
  incart:0},
  ...
  name:'haut-guillebot 2016',
  tag:"haut-guillebot 2016",
  image:'Boissons/vin alcool/chateau-haut-guillebot-bordeaux-supérieur-cuvée-prestige-2016.jpg',
  prix:0,
  prixu:1200,
  incart:0},
  ...
  name:'neho-likors ACMP',
  tag:"neho-likors ACMP",
  image:'Boissons/vin alcool/neho-likors-ananas-citron-mangue-passion.jpg',
  prix:0,
  prixu:300,
  incart:0},
  ...
  name:'neho-likors ACG',
  tag:"neho-likors ACG",
  image:'Boissons/vin alcool/neho-likors-ananas-citronnelle-gingembre.jpg',
  prix:0,
  prixu:900,
  incart:0},
  ...
  name:'chateau-haut-clary',
  tag:"chateau-haut-clary",
  image:'Boissons/vin alcool/vin-chateau-haut-clary.jpg',
  prix:0,
  prixu:2000,
  incart:0},
  ...
  name:'jp-chenet',
  tag:"jp-chenet",
  image:'Boissons/vin alcool/jp-chenet.jpg',
  prix:0,
  prixu:2000,
  incart:0},
  ...
  name:'caliendi-bitters',
  tag:"caliendi-bitters",
  image:'Boissons/vin alcool/caliendi-bitters.jpg',
  prix:0,
  prixu:200,
  incart:0},
  ...
  name:'caliendi-des-iles',
  tag:"caliendi-des-iles",
  image:'Boissons/vin alcool/caliendi-des-iles.jpg',
  prix:0,
  prixu:500,
  incart:0},
  ...
  name:'vin-aglianico-igt',
  tag:"vin-aglianico-igt",
  image:'Boissons/vin alcool/vin-aglianico-igt.jpg',
  prix:0,
  prixu:700,
  incart:0},
  ...
  name:'vin-sanserino-2017',
  tag:"vin-sanserino-2017",
  image:'Boissons/vin alcool/vin-sanserino-irpinia-rosso-doc-2017.jpg',
  prix:0,
  prixu:2000,
  incart:0},
  ...
  name:'black-old-man-ld7(2)',
  tag:"black-old-man-ld7(2)",
  image:'Boissons/vin alcool/liqueur-des-7-epices-black-old-man-ld7(2).jpg',
  prix:0,
  prixu:250,
  incart:0},
  ...
  name:'medil-liqueur-auw-epices',
  tag:"medil-liqueur-auw-epices ",
  image:'Boissons/vin alcool/medil-liqueur-auw-epices.jpg',
  prix:0,
  prixu:500,
  incart:0},
  ...
  name:'vin-terre-d-exception',
  tag:"vin-terre-d-exception",
  image:'Boissons/vin alcool/vin-terre-d-exception.jpg',
  prix:0,
  prixu:300,
  incart:0},
  ...
  name:'vin-comte-de-voraguet',
  tag:"vin-comte-de-voraguet",
  image:'Boissons/vin alcool/vin-comte-de-voraguet.jpg',
  prix:0,
  prixu:2200,
  incart:0}
...
let a=0;
  function setItems(product){
    ...
    if (cartItems != null && product.prix!=0) {
      ...
      if (product.incart==0) {
      cartItems[product.tag].prix =parseInt(price1.textContent)+parseInt(price2.textContent)+parseInt(price3.textContent)+parseInt(price4.textContent)+parseInt(price5.textContent)
      +parseInt(price6.textContent)+parseInt(price7.textContent)+parseInt(price8.textContent)+parseInt(price9.textContent)+parseInt(price10.textContent)+parseInt(price11.textContent)
      +parseInt(price12.textContent)+parseInt(price13.textContent)+parseInt(price14.textContent)+parseInt(price15.textContent)+parseInt(price16.textContent)+parseInt(price17.textContent)
      +parseInt(price18.textContent)+parseInt(price19.textContent)+parseInt(price20.textContent);a++;}
      else{cartItems[product.tag].prix = cartItems[product.tag].prix + parseInt(price1.textContent)+parseInt(price2.textContent)+parseInt(price3.textContent)+parseInt(price4.textContent)+parseInt(price5.textContent)
      +parseInt(price6.textContent)+parseInt(price7.textContent)+parseInt(price8.textContent)+parseInt(price9.textContent)+parseInt(price10.textContent)+parseInt(price11.textContent)
      +parseInt(price12.textContent)+parseInt(price13.textContent)+parseInt(price14.textContent)+parseInt(price15.textContent)+parseInt(price16.textContent)+parseInt(price17.textContent)
      +parseInt(price18.textContent)+parseInt(price19.textContent)+parseInt(price20.textContent);}
...
/*partie js pour ajout de produit---------------*/
  ...
  product.preventDefault();
    ...
    num4[0].style.display='block';num5[0].style.display='block';num6[0].style.display='block';
    num7[0].style.display='block';num8[0].style.display='block';num9[0].style.display='block';
    ...
    num16[0].style.display='block';num17[0].style.display='block';num18[0].style.display='block';  
   ...
   index1=0;index2=0;index3=0;index4=0;index5=0;index6=0;index7=0;index8=0;index9=0;index10=0;
    index11=0;index12=0;index13=0;index14=0;index15=0;index16=0;index17=0;index18=0;index19=0;index20=0;
}
function removeInitial(){
  num1[0].style.display='none';;num2[0].style.display='none';num3[0].style.display='none';
    num4[0].style.display='none';num5[0].style.display='none';num6[0].style.display='none';
    num7[0].style.display='none';num8[0].style.display='none';num9[0].style.display='none';
    ...
    num16[0].style.display='none';num17[0].style.display='none';num18[0].style.display='none';  
...
console.log("me voila--",parseInt(uprice1.textContent));
    ...
    price4.textContent=index4*parseInt(uprice4.textContent);price5.textContent=index5*parseInt(uprice5.textContent);price6.textContent=index6*parseInt(uprice6.textContent);
    price7.textContent=index7*parseInt(uprice7.textContent);price8.textContent=index8*parseInt(uprice8.textContent);price9.textContent=index9*parseInt(uprice9.textContent);
    ...
    price16.textContent=index16*parseInt(uprice16.textContent);price17.textContent=index17*parseInt(uprice17.textContent);price18.textContent=index18*parseInt(uprice18.textContent);
...
const closeModal= function(e){
  ...
  e.preventDefault();
    ...
    num4[index4].style.display='none';num5[index5].style.display='none';num6[index6].style.display='none';
    num7[index7].style.display='none';num8[index8].style.display='none';num9[index9].style.display='none';
    ...
    num16[index16].style.display='none';num17[index17].style.display='none';num18[index18].style.display='none';
