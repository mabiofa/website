...
let products = [
    {icrement:0.5,
  name:'Aubergine Africain (1/2Kg)',
  tag:"Aubergine1",
  image:'légumes/Aubergine africain (DJAMBA)3.jpg',
  prix:0,
  prixu:500,
  incart:0},
   {icrement:0.5,
  name:'Aubergine bengani (1/2Kg)',
  tag:"Aubergine2",
  image:'légumes/aubergine bengani3.jpg',
  prix:0,
  prixu:700,
  incart:0},

  {icrement:0.5,
  name:'Betteraves crimson (1/2Kg)',
  tag:"BetteravesCrimson",
  image:'légumes/betterave.jpg',
  prix:0,
  prixu:350,
  incart:0},
  ...
  name:'Brocolis (1/2Kg)',
  tag:"Brocolis (1/2Kg)",
  image:'légumes/brocoli1.jpg',
  prix:0,
  prixu:1250,
  incart:0},

  {icrement:1,
  name:'Choux blanc comette (1Kg)',
  tag:"Choux blanc comette (1Kg)",
  image:'légumes/Choux-blanc.jpg',
  prix:0,
  prixu:1000,
  incart:0},

  {icrement:1,
  name:'choux rouges (1Kg)',
  tag:"choux rouges (1Kg)",
  image:'légumes/choux-rouges.png',
  prix:0,
  prixu:1200,
  incart:0},

  {icrement:1,
  name:'Carottes Vanessa (1Kg)',
  tag:"Carottes Vanessa (1Kg)",
  image:'légumes/carotte5.jfif',
  prix:0,
  prixu:600,
  incart:0},
  ...
  name:'Comcombres (1Kg)',
  tag:"Comcombres (1Kg)",
  image:'légumes/comcombre poinsette+.jpg',
  prix:0,
  prixu:600,
  incart:0},

  {icrement:0.5,
  name:'Choux Fleure (1/2Kg)',
  tag:"Choux Fleure (1/2Kg)",
  image:'légumes/choux fleure1.jpg',
  prix:0,
  prixu:700,
  incart:0},
  ...
  name:'Gombo long (1Kg)',
  tag:"Gombo long (1Kg)",
  image:'légumes/gombos.jpg',
  prix:0,
  prixu:800,
  incart:0},

  {icrement:4,
  name:'Mais fraiche jaune (1Kg)',
  tag:"Mais fraiche jaune (1Kg)",
  image:'légumes/Mais jaune fraiche.jfif',
  prix:0,
  prixu:350,
  incart:0},

  {icrement:1,
  name:'Ognons-bruns (1Kg)',
  tag:"Ognons-bruns (1Kg)",
  image:'légumes/Oignons-bruns.jpg',
  prix:0,
  prixu:1000,
  incart:0},

  {icrement:1,
  name:'Piment (gboébéssé) (1Kg)',
  tag:"Piment (gboébéssé) (1Kg)",
  image:'légumes/Piment avenir (gboébéssé)1.jfif',
  prix:0,
  prixu:1200,
  incart:0},

  {icrement:0.5,
  name:'Ognon blanc (1/2Kg)',
  tag:"Ognon blanc (1/2Kg)",
  image:'légumes/ognon_blanc.jpg',
  prix:0,
  prixu:500,
  incart:0},

  {icrement:0.5,
  name:'Piment banane (1/2Kg)',
  tag:"Piment banane (1/2Kg)",
  image:'légumes/piment banane.png',
  prix:0,
  prixu:1000,
  incart:0},

  {icrement:0.5,
  name:'Ognon Rouge (1/2Kg)',
  tag:"Ognon Rouge (1/2Kg)",
  image:'légumes/oignon2.jpg',
  prix:0,
  prixu:450,
  incart:0},

  {icrement:0.5,
  name:'piment bec oiseau (1/2Kg)',
  tag:"piment bec oiseau (1/2Kg)",
  image:'légumes/piment-oiseau-copy-1680x730.jpg',
  prix:0,
  prixu:500,
  incart:0},

  {icrement:0.5,
  name:'Poivrons verte (1/2Kg)',
  tag:"Poivrons verte (1/2Kg)",
  image:'légumes/Poivrons vert.jpg',
  prix:0,
  prixu:700,
  incart:0},

  {icrement:1,
  name:'Tomates bobo (1Kg)',
  tag:"Tomates bobo (1Kg)",
  image:'légumes/tomate.jpg',
  prix:0,
  prixu:900,
  incart:0},

  {icrement:0.5,
  name:'Gboébéssé vert (1/2Kg)',
  tag:"Gboébéssé vert (1/2Kg)",
  image:'légumes/piment Gboébéssé vert.jpg',
  prix:0,
  prixu:650,
  incart:0}
...
/*partie js pour ajout de produit---------------*/
            ...
            var number20= document.getElementById('valeur20');
               ...
               span1.textContent =i*0.5;
                   span2.textContent =i*0.5;
                   span3.textContent =i*0.5;
                   span4.textContent =i*0.5;
                   span5.textContent =i;
                   span6.textContent =i;
                   span7.textContent =i;
                   span8.textContent =i;
                   span9.textContent =i*0.5;
                   span10.textContent =i;
                   span11.textContent =i*4;
                   span12.textContent =i;
                   span13.textContent =i;
                   span14.textContent =i*0.5;
                   span15.textContent =i*0.5;
                   span16.textContent =i*0.5;
                   span17.textContent =i*0.5;
                   span18.textContent =i*0.5;
                   span19.textContent =i;
               span20.textContent =i*0.5;
