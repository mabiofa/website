...
let products = [
    {icrement:0.5,
  name:'Le Moringa (1/2Kg)',
  tag:"Le Moringa (1/2Kg)",
  image:'végétaux/Le Moringa (Moringa oleifera).jfif',
  prix:0,
  prixu:400,
  incart:0},
   {icrement:0.25,
...
*/
  ...
  name:'Basilic (300g)',
  tag:"Basilic (300g)",
  image:'végétaux/15 bienfaits du basilic.jfif',
  prix:0,
  prixu:600,
  incart:0},
/*
...
*/
  {icrement:250,
  name:'Gombo_kirikou2 (1Kg)',
  tag:"Gombo_kirikou2 (1Kg)",
  image:'végétaux/Gombo_kirikou1.jpg',
  prix:0,
  prixu:300,
  incart:0},
/*
...
let a=0;
  function setItems(product){
    ...
    +parseInt(price5.textContent)
     ...
     +parseInt(price18.textContent);
     ;//+parseInt(price19.textContent)+parseInt(price20.textContent);
