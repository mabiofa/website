...
<div class="ins-container">
	<nav class="cdg1">
     ...
     <div class="bienvenu-section">
      <div class="first">
        <p align="center">Recharge en cours de traitement ....</p>
        Bienvenue une fois de plus a vous Monsieur/Madame <span class="first-nom"><?php echo $prenom;echo " ";  echo $nom; ?></span><br>
        Nous vous prions de bien vouloir patienter nous allons traiter votre demande dans les plus bref delais .Si dans 48h vous n'avez pas ete solde contacter nous <a href="Contact.php">Mabiofa</a> depuis notre plateforme.<br>
