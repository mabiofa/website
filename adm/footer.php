 ...
 <footer>
            ...
            <div class="btns">
                <strong class="btn1text">Inscrivez-vous à la news letter</strong> 
                
                 <form >
                    <div class="search-zone">
                                   
                                    <input type="text" placeholder="Enter your mail">
                                     <div class="search-area">Email</div>
                     </div>
                 </form>
            </div>
            ...
            <div class="wrapper">
                ...
                <ul class="ul2">
                    ...
                    <li>Parce que nous garantissons votre bien etre tout en préservant votre environnement</li>
                </ul>
                <ul class="ul3">
                ...
                <ul class="ul1">
                    ...
                    <li class="nav-text"><a href="../layout/Profil.php">Mon profil</a></li>
                    <li class="nav-text"><a href="../layout/abonnement.php">Abonnement</a></li>
                    <li class="nav-text"><a href="../layout/Promotions.php">Promotions</a></li>
                    ...
                    <li class="nav-text"><a href="../layout/Page de deconnection.php">Deconnection</a></li>
                </ul>
                <ul class="ul4">
   ...
   const hamburger=document.querySelector(".hamburger");
    const navlinks=document.querySelector(".prod-menu2");
     const links=document.querySelectorAll(".prod-menu2 li");
